...
class PID:
    ...
    def steerControl(self, x, x_d, prev_e, prev_int):
        ...
        # Find the steering control, u(t) = Kp*e + Ki*Integral(error) + Kd* derivative(error)
        # u_steer = offset angle from heading angle and vector to next waypoint
        ...
        # Return control(offset angle) value and updated error and error integral values
